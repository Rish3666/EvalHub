            ...
            <div className="px-4 py-6 space-y-6">
                <div className="space-y-1">
                    ...
                    <p className="text-muted-foreground text-sm font-medium">
                        by {project.author.full_name} · Generated by EvalHub AI
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pb-12">
                    <div className="p-6 rounded-2xl bg-green-500/5 border border-green-500/10 space-y-4">
                        <h3 className="font-black text-green-500 flex items-center gap-2 italic tracking-tighter uppercase">✨ Strengths</h3>
                    ...
                    <div className="p-6 rounded-2xl bg-orange-500/5 border border-orange-500/10 space-y-4">
                        <h3 className="font-black text-orange-500 flex items-center gap-2 italic tracking-tighter uppercase">📈 Improve</h3>
                        <ul className="space-y-2">
